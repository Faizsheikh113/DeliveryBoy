...
import { View, Text, StyleSheet, Dimensions, TouchableOpacity, ActivityIndicator, TextInput, Alert, FlatList, RefreshControl, Modal } from 'react-native';
...
export const Cancle_Order = ({ navigation }) => {
    ...
    const GetProduct = useCallback(async () => {
        try {
            ...
            const filteredOrderList = response?.data?.OrderList.filter(ele => ele?.status === "Cancel in process") || [];
    ...
    const Header = () => (
        <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Cancelled Order</Text>
        </View>
    );
                ...
                <Card.Content style={styles.content}>
                    ...
                    <View style={styles.priceContainer}>
                        ...
                        <Text style={{
                            color: 'black',
                            fontSize: calculateFontSizePercentage(3),
                            marginLeft: calculateWidthPercentage(10.5)
                        }} numberOfLines={3}>
